 ...
 * if (!result.safe) console.log(result.output);
 * ```
 */
...
export type { PIIPatternId, PatternConfidence, PIIPatternConfig, PIIMatch, MaskMode, CustomPIIPattern } from './pii-patterns.js';

// Reversible tokenized redaction — opaque hashes
...
// NER rules A–J: structured name detection for legal/police documents
