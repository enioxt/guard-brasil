 ...
 * Convention: `<namespace>:<identifier>` e.g. `tjmg:processo_estadual`.
...
// Complement Brazilian PII with infrastructure credential detection.
// NOT included in ALL_PII_PATTERNS to avoid false positives in general text.
// Use INFRASTRUCTURE_SECRET_PATTERNS explicitly when scanning source code or config files.
